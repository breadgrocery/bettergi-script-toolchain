...
export interface Bgra32
  ...
  bgra: number;
  packedValue: number;
  createPixelOperations(): SixLabors.ImageSharp.PixelFormats.PixelOperations<SixLabors.ImageSharp.PixelFormats.Bgra32>;
  ...
  equals(other: SixLabors.ImageSharp.PixelFormats.Bgra32): boolean;
  getHashCode(): number;
  toString(): string;
}
...
declare global {
  namespace SixLabors.ImageSharp.PixelFormats {
    type Bgra32 = import("./Bgra32").Bgra32;
  }
}

export interface Bgra32HostType extends HostType<Bgra32, ValueTypeTrait> {
  new (
