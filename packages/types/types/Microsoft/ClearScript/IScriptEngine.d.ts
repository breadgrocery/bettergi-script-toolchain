...
import type { EnumInput, HostArray, HostType, InterfaceTypeTrait } from "./HostType";
import "./ScriptAccess";
import "./ScriptObject";
import type { VoidResult } from "./VoidResult";

declare const iScriptEngineInputBrand: unique symbol;
export interface IScriptEngineInput {
  readonly [iScriptEngineInputBrand]: true;
}

export interface IScriptEngine
  extends Microsoft.ClearScript.ClrInterfaceView<IScriptEngineInput>, IScriptEngineInput {
...
declare global {
  namespace Microsoft.ClearScript {
    type IScriptEngineInput = import("./IScriptEngine").IScriptEngineInput;
  }
}

declare global {
  namespace Microsoft.ClearScript {
    type IScriptEngine = import("./IScriptEngine").IScriptEngine;
  }
}

export interface IScriptEngineHostType extends HostType<IScriptEngine, InterfaceTypeTrait> {}
