...
export interface UInt64
  ...
  compareTo(value: number | StrongNumeric<UInt64Host>): number;
  compareTo(value: unknown | null): number;
  equals(obj: number | StrongNumeric<UInt64Host>): boolean;
...
declare global {
  namespace System {
    type UInt64 = import("./UInt64").UInt64;
  }
}

export interface UInt64HostType extends HostType<UInt64, ValueTypeTrait> {
  ...
  divRem(
    left: number | StrongNumeric<UInt64Host>,
    right: number | StrongNumeric<UInt64Host>
  ): System.ValueTuple<number, number>;
  leadingZeroCount(value: number | StrongNumeric<UInt64Host>): number;
  popCount(value: number | StrongNumeric<UInt64Host>): number;
  rotateLeft(
  ...
  trailingZeroCount(value: number | StrongNumeric<UInt64Host>): number;
  isPow2(value: number | StrongNumeric<UInt64Host>): boolean;
  log2(value: number | StrongNumeric<UInt64Host>): number;
  clamp(
    value: number | StrongNumeric<UInt64Host>,
    min: number | StrongNumeric<UInt64Host>,
    max: number | StrongNumeric<UInt64Host>
  ): number;
  max(x: number | StrongNumeric<UInt64Host>, y: number | StrongNumeric<UInt64Host>): number;
  min(x: number | StrongNumeric<UInt64Host>, y: number | StrongNumeric<UInt64Host>): number;
  sign(value: number | StrongNumeric<UInt64Host>): number;
  ...
  isEvenInteger(value: number | StrongNumeric<UInt64Host>): boolean;
  isOddInteger(value: number | StrongNumeric<UInt64Host>): boolean;
  tryParse(
    s: string | null,
    provider: System.IFormatProvider | null,
    result: HostVariableOut<number>
