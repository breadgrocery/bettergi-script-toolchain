...
declare const int16Brand: unique symbol;
export interface Int16
  ...
  readonly [int16Brand]: true;
  compareTo(value: number | StrongNumeric<Int16Host>): number;
  compareTo(value: unknown | null): number;
  equals(obj: number | StrongNumeric<Int16Host>): boolean;
...
declare global {
  namespace System {
    type Int16 = import("./Int16").Int16;
  }
}

export interface Int16HostType extends HostType<Int16, ValueTypeTrait> {
  ...
  divRem(
    left: number | StrongNumeric<Int16Host>,
    right: number | StrongNumeric<Int16Host>
  ): System.ValueTuple<number, number>;
  leadingZeroCount(value: number | StrongNumeric<Int16Host>): number;
  popCount(value: number | StrongNumeric<Int16Host>): number;
  rotateLeft(
  ...
  trailingZeroCount(value: number | StrongNumeric<Int16Host>): number;
  isPow2(value: number | StrongNumeric<Int16Host>): boolean;
  log2(value: number | StrongNumeric<Int16Host>): number;
  clamp(
    value: number | StrongNumeric<Int16Host>,
    min: number | StrongNumeric<Int16Host>,
    max: number | StrongNumeric<Int16Host>
  ): number;
  copySign(
    value: number | StrongNumeric<Int16Host>,
    sign: number | StrongNumeric<Int16Host>
  ): number;
  max(x: number | StrongNumeric<Int16Host>, y: number | StrongNumeric<Int16Host>): number;
  min(x: number | StrongNumeric<Int16Host>, y: number | StrongNumeric<Int16Host>): number;
  sign(value: number | StrongNumeric<Int16Host>): number;
  abs(value: number | StrongNumeric<Int16Host>): number;
  ...
  isEvenInteger(value: number | StrongNumeric<Int16Host>): boolean;
  isNegative(value: number | StrongNumeric<Int16Host>): boolean;
  isOddInteger(value: number | StrongNumeric<Int16Host>): boolean;
  isPositive(value: number | StrongNumeric<Int16Host>): boolean;
  maxMagnitude(x: number | StrongNumeric<Int16Host>, y: number | StrongNumeric<Int16Host>): number;
  minMagnitude(x: number | StrongNumeric<Int16Host>, y: number | StrongNumeric<Int16Host>): number;
  tryParse(
    s: string | null,
    provider: System.IFormatProvider | null,
    result: HostVariableOut<number>
