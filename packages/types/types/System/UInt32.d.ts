...
export interface UInt32
  ...
  readonly [uInt32Brand]: true;
  compareTo(value: number | StrongNumeric<UInt32Host>): number;
  compareTo(value: unknown | null): number;
  equals(obj: number | StrongNumeric<UInt32Host>): boolean;
...
declare global {
  namespace System {
    type UInt32 = import("./UInt32").UInt32;
  }
}

export interface UInt32HostType extends HostType<UInt32, ValueTypeTrait> {
  ...
  divRem(
    left: number | StrongNumeric<UInt32Host>,
    right: number | StrongNumeric<UInt32Host>
  ): System.ValueTuple<number, number>;
  leadingZeroCount(value: number | StrongNumeric<UInt32Host>): number;
  popCount(value: number | StrongNumeric<UInt32Host>): number;
  rotateLeft(
  ...
  trailingZeroCount(value: number | StrongNumeric<UInt32Host>): number;
  isPow2(value: number | StrongNumeric<UInt32Host>): boolean;
  log2(value: number | StrongNumeric<UInt32Host>): number;
  clamp(
    value: number | StrongNumeric<UInt32Host>,
    min: number | StrongNumeric<UInt32Host>,
    max: number | StrongNumeric<UInt32Host>
  ): number;
  max(x: number | StrongNumeric<UInt32Host>, y: number | StrongNumeric<UInt32Host>): number;
  min(x: number | StrongNumeric<UInt32Host>, y: number | StrongNumeric<UInt32Host>): number;
  sign(value: number | StrongNumeric<UInt32Host>): number;
  ...
  isEvenInteger(value: number | StrongNumeric<UInt32Host>): boolean;
  isOddInteger(value: number | StrongNumeric<UInt32Host>): boolean;
  tryParse(
    s: string | null,
    provider: System.IFormatProvider | null,
    result: HostVariableOut<number>
