...
declare const xmlWhitespaceBrand: unique symbol;
export interface XmlWhitespace
  extends
    Omit<
  ...
  readonly [xmlWhitespaceBrand]: true;
...
declare global {
  namespace System.Xml {
    type XmlWhitespace = import("./XmlWhitespace").XmlWhitespace;
  }
}

export interface XmlWhitespaceHostType extends HostType<XmlWhitespace, ReferenceTypeTrait> {}
